...
def save_checkpoint(state, is_best, checkpoint='checkpoint', filename='checkpoint_vgg16_L2H_freeze_cifar100.pth.tar'):
...
model.train()
torch.save(model.state_dict(), 'FreezeOut_L2H_vgg_20_cifar100_new_epochs')
...
# load the weight
net.load_state_dict(torch.load('FreezeOut_L2H_vgg_20_cifar100_new_epochs'))
