...
def save_checkpoint(state, is_best, checkpoint='checkpoint', filename='checkpoint_res110_freeze_startNRE.pth.tar'):
...
torch.save(model.state_dict(), 'res110_freeze_start_epochsNRE')
...
# load the weight
net.load_state_dict(torch.load('res110_freeze_start_epochsNRE'))
