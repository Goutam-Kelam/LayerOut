...
def save_checkpoint(state, is_best, checkpoint='checkpoint', filename='checkpoint_vgg16_new_freezeH2L_RE.pth.tar'):
...
model.train()
torch.save(model.state_dict(), 'FreezeOut_vgg_20_H2L_REepochs')
...
# load the weight
net.load_state_dict(torch.load('FreezeOut_vgg_20_H2L_REepochs'))
