...
def save_checkpoint(state, is_best, checkpoint='checkpoint', filename='checkpoint_vgg16_new_freezeL2H_NRE.pth.tar'):
...
model.train()
torch.save(model.state_dict(), 'FreezeOut_vgg_20_newL2H_NREepochs')
...
# load the weight
net.load_state_dict(torch.load('FreezeOut_vgg_20_newL2H_NREepochs'))
