...
def save_checkpoint(state, is_best, checkpoint='checkpoint', filename='checkpoint_res110_freeze_20.pth.tar'):
...
for epoch in range(start_epoch, start_epoch+20):
    ...
    print('Best acc1:')
    print(best_acc1)
    print("Avg time/epoch {}".format(sum(train_time)/len(train_time)))

#assert False
model.train()

torch.save(model.state_dict(), 'res110_freeze_20_epochs')
...
# load the weight
net.load_state_dict(torch.load('res110_freeze_20_epochs'))
...
for epoch in range(start_epoch+20,args.epochs):
    ...
    print('Best acc:')
    print(best_acc1)
    print("Avg time/epoch {}".format(sum(f_t_time)/len(f_t_time)))
