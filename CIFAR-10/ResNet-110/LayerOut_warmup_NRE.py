...
def save_checkpoint(state, is_best, checkpoint='checkpoint', filename='checkpoint_Res110_NRE.pth.tar'):
...
torch.save(model.state_dict(), 'res_10_NRE')
...
# load the weight
net.load_state_dict(torch.load('res_10_NRE'))
...
print("---"*50)
print("Layerwise split: {}".format(f_counter))
print("Total No. of layers frozen: {}".format(sum(f_counter)))
