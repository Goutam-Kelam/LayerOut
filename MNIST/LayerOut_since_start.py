...
def save_checkpoint(state, is_best, checkpoint='checkpoint', filename='checkpoint_conv.pth.tar'):
...
def Freeze_train(trainloader, net, criterion, optimizer, epoch, use_cuda,prob,lr):
    net.train()
    train_loss = 0
    correct = 0
    total = 0
...
for epoch in range(start_epoch, 100):
    ...
    train_loss, train_acc,prob = Freeze_train(trainloader,model, criterion, optimizer, epoch, use_cuda,prob,state['lr'])
