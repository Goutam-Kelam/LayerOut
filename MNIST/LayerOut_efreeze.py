...
model.train()
torch.save(model.state_dict(), 'FreezeOut_12layer_L2H_20epochs')
...
# load the weight
net.load_state_dict(torch.load('FreezeOut_12layer_L2H_20epochs'))
...
prob = torch.from_numpy(np.array([0.1,0.3,0.4,0.5,0.6,0.7,0.9]))
prob_alpha = 0.067
